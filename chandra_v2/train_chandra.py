...
from chandra_finetune.data import load_chandra_dataset, samples_to_training_records
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--finetune-vision-layers", action=argparse.BooleanOptionalAction, default=True)
...
def main() -> None:
    ...
    eval_samples = load_chandra_dataset(args.eval_dataset) if args.eval_dataset else []
    ...
    print(f"Loaded {len(samples)} train samples and {len(eval_samples)} eval samples.")
